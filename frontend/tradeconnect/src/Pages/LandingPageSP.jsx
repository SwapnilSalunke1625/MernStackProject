...
export default function LandingPageSP() {
    ...
    return (
        <div className="min-h-screen bg-gradient-to-b from-stdBg to-white py-6">
                    ...
                    <div className="bg-white rounded-2xl shadow-lg overflow-hidden transform transition-all hover:shadow-xl">
                        ...
                        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 p-4 sm:p-6 md:p-8">
                            {[
                                ...
                                { icon: <FaClock className="text-3xl text-yellow-500" />, label: "Pending", value: stats.pendingJobs, color: "text-yellow-600" },
                                { icon: "✅", label: "Accepted", value: stats.acceptedJobs, color: "text-gray-600" },
                                { icon: <FaCalendarCheck className="text-3xl text-green-500" />, label: "Completed", value: stats.completedJobs, color: "text-green-600" }
                            ].map((stat, index) => (
                                <div key={index} 
